#Adapted from: https://github.com/amorten/openlis/blob/master/openlis/model/recursive_model_index_simple.py
...
class RMI_simple(object):
    ...
    def __init__(self, data_set, hidden_layer_widths=[16,16], num_experts=10):
        ...
        self.run_inference = partial(self._run_inference_numpy_n_hidden, num_hidden_layers=num_hidden_layers)
    ...
    def calc_min_max_errors(self,
        ...
        """Calculates the errors each Stage 2 expert makes in predicting the 
           keys position. Inference is run on the full data set to get the errors.
    ...
    def _run_inference_numpy_n_hidden(self, keys, num_hidden_layers):
